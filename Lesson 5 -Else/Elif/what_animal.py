...
print("Question 1: Do you prefer to be indoors or outdoors?")
print("a) Indoors")
print("b) Outdoors")
...
if input() == "a":
    ...
    print("You are a cat! You love to be indoors.")
else: print("You are a dog! You love to be outdoors.")
    # Ask the next question
print("Question 2: Do you prefer to be active or relaxed?")
print("a) Active")
print("b) Relaxed")
...
if input()=="a":
        # Tell them they're animal 1
        print("You are a rabbit! You love to be active.")
...
else: print ("You are a sloth! You love to be relaxed.")

# Otherwise

# Ask the next question
print("Question 3: Do you prefer to be in a group or alone?")
print("a) In a group")
print("b) Alone")
...
if input()=="a":
        ...
        print("You are a dog! You love to be in a group.")

    # Otherwise

        # Tell them they're animal 4 
else: print("You are a cat! You love to be alone.")
